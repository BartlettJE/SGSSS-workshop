...
* [Telling Stories with Data](https://tellingstorieswithdata.com/) by Rohan Alexander is a comprehensive online book on statistical communication, programming, and modelling in R. 

## Writing reproducible manuscripts 

* [Using papaja to create reproducible APA manuscripts](https://github.com/BartlettJE/papaja_demo) James delivered a workshop on using papaja to create reproducible APA manuscripts in RStudio.

* [Reproducible APA manuscripts with R Markdown](https://frederikaust.com/papaja_man/) the original authors Aust and Barth have a comprehensive online book outlining the key features of papaja. 
